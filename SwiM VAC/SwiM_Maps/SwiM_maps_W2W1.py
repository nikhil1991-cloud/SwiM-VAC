...
path_to_txt_file = '/Users/Nikhil/code/Newtext/Matchtxt/' #Path to store text file that contains MaNGA IDs of galaxies that have only uvw1 & uvw2 observations
...
with open(path_to_txt_file+'W2W1TOT.txt') as f:#W2W1TOT.txt is a txt file that contains MaNGA IDs of galaxies that have only uvw1 and uvw2 observations
   Line = [line.rstrip('\n') for line in open(path_to_txt_file+'W2W1TOT.txt')]
