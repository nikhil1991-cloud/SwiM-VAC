...
Step 3: Use the code Flux.py to generate the sky-subtracted Swift flux maps. This code will use the aperture corrections fits file and the cutout images of Swift filters (generated using Cutout.py). This code will generate the Swift flux maps which will have the following information in the header of the first HDU:
